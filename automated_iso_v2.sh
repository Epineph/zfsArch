...
cd $USER_DIR/ISOBUILD; mv releng/ zfsiso; cd $ISO_HOME; sleep 1

mkdir -p $ZFS_REPO_DIR; cd $ZFS_REPO_DIR; cp $BUILD_DIR/zfs-dkms/*.zst .
sleep 2; cp $BUILD_DIR/zfs-utils/*.zst .; sleep 2
